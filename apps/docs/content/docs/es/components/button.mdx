...
<Callout variant="tip">
  ...
  <CalloutDescription>
    ...
    terminado, por lo que puede no funcionar como se espera. Por favor, vuelve
    en otro momento.
  </CalloutDescription>
</Callout>
...
<Steps>
  ...
  <Step>
    Actualice las rutas de importación para que coincidan con la configuración de su proyecto.
  </Step>
</Steps>
...
<Callout variant="warning">
  <CalloutTitle>No disponible por el momento.</CalloutTitle>
</Callout>
