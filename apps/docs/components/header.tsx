...
export function Navbar() {
  ...
  return (
    <header className="flex border-b border-dashed  px-5 md:px-10 lg:px-20 justify-between items-center sticky top-0 left-0 backdrop-blur-xl z-50 max-w-[1580px] mx-auto w-full">
