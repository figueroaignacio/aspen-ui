...
const buttonStyles: Record<ButtonVariant, string> = {
  default:
    "border text-center text-foreground rounded-md text-xs flex items-center gap-2 justify-center py-2 px-5 bg-primary hover:bg-primary-foreground text-nowrap",
  destructive:
    ...
    return (
      <button
        className={cn(
          ...
          buttonVariants(variant, size), // Usa buttonVariants aquí
          className
        )}
        ref={ref}
        {...props}
