...
function DropdownMenuTrigger({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex justify-between w-full rounded-md border px-4 py-2 bg-primary hover:bg-primary-foreground text-sm font-medium text-foregroundz active:scale-95 transition-all duration-200",
        className
      )}
    >
      {children}
  ...
  return (
    isOpen && (
      <div
        ...
        className={cn(
          "absolute mt-2 w-full rounded-sm bg-background shadow-lg z-10 border border-border px-2",
          className
        )}
        role="menu"
        aria-hidden={!isOpen}
